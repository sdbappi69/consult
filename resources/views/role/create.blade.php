            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="form-group col-md-6">
                                ...
                                {!! Form::text('name',old('name'),['class'=>'form-control form-control-sm','id'=>'title','required'=>True]) !!}
                            </div>
                            <div class="form-group col-md-6">
                                <label for="guard">Guard Name</label>
                                {!! Form::text('guard',old('guard'),['class'=>'form-control form-control-sm','id'=>'guard','required'=>True]) !!}
                            </div>
                            <div class="form-group col-md-12">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-5">
                                        {{ Form::select('permission[]',[],null, ['class' => 'form-control', 'id' => 'lstBox2','size' => 10,'required'=>true, 'multiple']) }}
                                    </div>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="card-footer text-center">
                        {!! Form::submit('Submit',['class'=>'btn btn-success','id'=>'select_all']) !!}
                    </div>
                </div>
            </div>
        </div>
